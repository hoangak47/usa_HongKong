...
CKEDITOR.editorConfig = function( config ) {
    ...
    config.extraPlugins ='image2,ckeditorfa,youtube,lineheight';
    config.line_height = '0.5;0.8;1;1.1;1.2;1.3;1.4;1.5;2;2.5;3';
    ...
    config.filebrowserBrowseUrl = ASSET + ADPATH + '/ckfinder';
