...
class AllController
{
    function composer($view)
    {
        ...
        $admin_url = $optSetting['admin_url'] ?? null;
        ...
        $view->share(['admin_path'=> $admin_path,'admin_url'=> $admin_url,'upload' => $upload, 'configType' => $configType, 'page' => $page, 'com' => $com, 'act' => $act, 'type' => $type, 'kind' => $kind, 'tb' => $tb, 'configMan' => $configMan, 'logo' => $logoPhoto, 'social' => $social, 'permissions' => $permissions ?? []]);
    }
}
