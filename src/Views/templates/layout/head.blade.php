...
@if(($com ?? '') == 'trang-chu')
<link rel="preload" href="{{ assets_photo('photo', config('type.photo.'.$slider[0]['type'].'.thumb'), $slider[0]['photo'], 'thumbs') }}" as="image">
<link rel="preload" href="{{ assets_photo('photo', config('type.photo.'.$slider[0]['type'].'.thumb2'), $slider[0]['photo'], 'thumbs') }}" as="image">
@endif